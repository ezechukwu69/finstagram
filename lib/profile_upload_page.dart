...
class ProfileUploader extends StatefulWidget {
  @override
  _ProfileUploader createState() => _ProfileUploader();
}

class _ProfileUploader extends State<ProfileUploader> {
        ...
        Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child: StreamBuilder(
                stream: FirebaseFirestore.instance.doc('/insta_users/${googleSignIn.currentUser.id}').snapshots(),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: AspectRatio(
                  aspectRatio: 487 / 451,
                  child: !file.path.contains("mp4") ? Container(
                    decoration: BoxDecoration(
...
Future<String> uploadImage(File imageFile) async {
  var uuid = Uuid().v1();
  StorageReference ref = FirebaseStorage.instance.ref().child("post_$uuid.${imageFile.path}");
...
void postToFireStore(
  ...
  var reference = FirebaseFirestore.instance.doc('insta_users/${googleSignIn.currentUser.id}');
